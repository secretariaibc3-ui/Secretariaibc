...
export const AgendaBottomSheet: React.FC<AgendaBottomSheetProps> = ({
  ...
  return (
    <AnimatePresence>
              ...
              {tab === "event" ? (
                <div className="space-y-2">
                  ...
                  <div
                    ...
                    onClick={() => {
                      if (!isAdmin) return;
                      setIsMinistrySelectorOpen(true);
                    }}
                  >
      ...
      {/* Ministry Selector Modal */}
      <AnimatePresence>
        {isMinistrySelectorOpen && (
          <motion.div
          ...
          >
            <div
              ...
              onClick={() => setIsMinistrySelectorOpen(false)}
            />

            <div className="bg-white dark:bg-[#111] w-full max-w-lg rounded-3xl shadow-2xl overflow-hidden flex flex-col relative z-10 max-h-[85vh] border border-gray-100 dark:border-[#222]">
              {/* Header */}
              ...
              {/* List */}
              <div className="shrink min-h-0 overflow-y-auto p-2 custom-scrollbar bg-white dark:bg-[#111]">
                <div
                  onClick={() => {
                    setMinistryId("");
                    setIsMinistrySelectorOpen(false);
                  }}
                ...
                >
                  ...
                  >
                    {ministryId === "" && <CheckCircle className="w-3.5 h-3.5" />}
                  </div>
                  <span className="text-sm font-bold text-gray-900 dark:text-white">
                    Nenhum ministério relacionado
                  </span>
                </div>
                ...
                {ministries
                  .filter((m) =>
                    m.name
                      .toLowerCase()
                      .includes(ministrySearch.toLowerCase())
                  )
                  .sort((a, b) => a.name.localeCompare(b.name))
                  .map((ministry) => {
                    const isSelected = ministryId === ministry.id;
