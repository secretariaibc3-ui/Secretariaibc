...
export const DomingoEscala = ({ members, escala, onUpdate, isAdmin, onBack }: { members: Member[], escala: Escala, onUpdate: (e: Escala) => void, isAdmin: boolean, onBack: () => void }) => {
  ...
  return (
    <div className="p-4 space-y-6">
      <div className="flex items-center gap-4">
        ...
        <h2 className="text-2xl font-black">Domingo</h2>
      </div>
